...
if __name__ == "__main__":
    ...
    subset_df['S'] = subset_df['Sex'].apply(lambda x: 1 if x == 'Female' else 0)
    ...
    subset_df['A'] = subset_df['Pacemaker']
    ...
    subset_df['YAS'] = subset_df[['Y','Pacemaker','S']].apply(tuple, axis=1).map(YAS_map)
    ...
    subset_df['AS'] = subset_df[['Pacemaker','S']].apply(tuple, axis=1).map(AS_map)
